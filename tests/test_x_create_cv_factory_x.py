...
def test_cli_audit_writes_human_readable_office_report(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert sorted(report["audit_policy"].keys()) == [
    ...
    for comparison in report["comparisons"]:
        ...
        assert "error" not in comparison["source"]["structure"]
    ...
    assert (
        len(report["comparisons"][1]["source"]["normalized_text"]["sha256"])
        == expected_docx_normalized_text_sha256_length
    )
    assert (
        len(report["comparisons"][2]["generated"]["normalized_text"]["sha256"])
        == expected_docx_normalized_text_sha256_length
    )
    assert (
    ...
    assert (
        report["comparisons"][3]["generated"]["normalized_text"]["sha256"]
        == report["comparisons"][3]["source"]["normalized_text"]["sha256"]
    )
    ...
    assert report["comparisons"][0]["generated"]["structure"]["has_styles"] == expected_xlsx_has_styles
    assert report["comparisons"][0]["source"]["structure"]["has_styles"] == expected_xlsx_has_styles
    assert (
    ...
    assert (
        report["comparisons"][0]["generated"]["structure"]["content_type_overrides"]
        == report["comparisons"][0]["source"]["structure"]["content_type_overrides"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheet_count"]
        == report["comparisons"][0]["source"]["structure"]["sheet_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheet_names"]
        == report["comparisons"][0]["source"]["structure"]["sheet_names"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"]
        == report["comparisons"][0]["source"]["structure"]["sheets"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["name"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["name"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["path"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["path"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["dimension"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["dimension"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["row_count"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["row_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["column_count"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["column_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["styled_cell_count"]
    ...
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["name"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["name"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["path"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["path"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["dimension"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["dimension"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["row_count"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["row_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["column_count"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["column_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["headers"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["headers"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["styled_cell_count"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["styled_cell_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["cell_type_counts"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["cell_type_counts"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["auto_filter_ref"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["auto_filter_ref"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["freeze_pane"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["freeze_pane"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["page_margins"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["page_margins"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][1]["column_widths"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][1]["column_widths"]
    )
    assert (
    ...
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["freeze_pane"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["freeze_pane"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["auto_filter_ref"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["auto_filter_ref"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["page_margins"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["page_margins"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["sheets"][0]["column_widths"]
        == report["comparisons"][0]["source"]["structure"]["sheets"][0]["column_widths"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]
        == report["comparisons"][0]["source"]["structure"]["styles"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["workbook_relationship_targets"]
        == report["comparisons"][0]["source"]["structure"]["workbook_relationship_targets"]
    ...
    assert (
        report["comparisons"][0]["generated"]["structure"]["has_core_properties"]
        == report["comparisons"][0]["source"]["structure"]["has_core_properties"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["has_extended_properties"]
        == report["comparisons"][0]["source"]["structure"]["has_extended_properties"]
    ...
    assert (
        report["comparisons"][0]["generated"]["structure"]["has_styles"]
        == report["comparisons"][0]["source"]["structure"]["has_styles"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["part_count"]
        == report["comparisons"][0]["source"]["structure"]["part_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["bold_font_indexes"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["bold_font_indexes"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["border_colors"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["border_colors"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["border_count"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["border_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["cell_style_count"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["cell_style_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["cell_xfs"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["cell_xfs"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["cell_xfs_count"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["cell_xfs_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["fill_count"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["fill_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["fill_fg_colors"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["fill_fg_colors"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["font_colors"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["font_colors"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["font_count"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["font_count"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["font_names"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["font_names"]
    )
    assert (
        report["comparisons"][0]["generated"]["structure"]["styles"]["italic_font_indexes"]
        == report["comparisons"][0]["source"]["structure"]["styles"]["italic_font_indexes"]
    )
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["style_definition_count"]
        == report["comparisons"][3]["source"]["structure"]["style_definition_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["style_definition_count"]
        == expected_docx_style_definition_count
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["part_count"]
        == report["comparisons"][2]["source"]["structure"]["part_count"]
    )
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["part_count"]
        == report["comparisons"][3]["source"]["structure"]["part_count"]
    )
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["has_theme"]
        == report["comparisons"][2]["source"]["structure"]["has_theme"]
    )
    assert report["comparisons"][2]["generated"]["structure"]["has_theme"] == expected_docx_has_theme
    assert report["comparisons"][2]["source"]["structure"]["has_theme"] == expected_docx_has_theme
    assert (
        report["comparisons"][3]["generated"]["structure"]["has_theme"]
        == report["comparisons"][3]["source"]["structure"]["has_theme"]
    )
    assert report["comparisons"][3]["generated"]["structure"]["has_theme"] == expected_docx_has_theme
    assert report["comparisons"][3]["source"]["structure"]["has_theme"] == expected_docx_has_theme
    expected_docx_has_font_table = True
    assert (
        report["comparisons"][1]["generated"]["structure"]["has_font_table"]
        == report["comparisons"][1]["source"]["structure"]["has_font_table"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["has_font_table"] == expected_docx_has_font_table
    assert report["comparisons"][1]["source"]["structure"]["has_font_table"] == expected_docx_has_font_table
    assert (
        report["comparisons"][2]["generated"]["structure"]["has_font_table"]
        == report["comparisons"][2]["source"]["structure"]["has_font_table"]
    )
    assert report["comparisons"][2]["generated"]["structure"]["has_font_table"] == expected_docx_has_font_table
    assert report["comparisons"][2]["source"]["structure"]["has_font_table"] == expected_docx_has_font_table
    assert (
        report["comparisons"][3]["generated"]["structure"]["has_font_table"]
        == report["comparisons"][3]["source"]["structure"]["has_font_table"]
    )
    assert report["comparisons"][3]["generated"]["structure"]["has_font_table"] == expected_docx_has_font_table
    assert report["comparisons"][3]["source"]["structure"]["has_font_table"] == expected_docx_has_font_table
    expected_docx_has_web_settings = True
    assert (
        report["comparisons"][1]["generated"]["structure"]["has_web_settings"]
        == report["comparisons"][1]["source"]["structure"]["has_web_settings"]
    )
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["has_web_settings"]
        == report["comparisons"][3]["source"]["structure"]["has_web_settings"]
    )
    assert report["comparisons"][3]["generated"]["structure"]["has_web_settings"] == expected_docx_has_web_settings
    assert report["comparisons"][3]["source"]["structure"]["has_web_settings"] == expected_docx_has_web_settings
    expected_docx_has_footnotes = True
    assert (
        report["comparisons"][1]["generated"]["structure"]["has_footnotes"]
        == report["comparisons"][1]["source"]["structure"]["has_footnotes"]
    )
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["has_footnotes"]
        == report["comparisons"][2]["source"]["structure"]["has_footnotes"]
    )
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["has_footnotes"]
        == report["comparisons"][3]["source"]["structure"]["has_footnotes"]
    )
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["has_endnotes"]
        == report["comparisons"][2]["source"]["structure"]["has_endnotes"]
    )
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["has_custom_xml"]
        == report["comparisons"][3]["source"]["structure"]["has_custom_xml"]
    )
    ...
    assert report["comparisons"][3]["generated"]["structure"]["has_custom_xml"] == expected_docx_has_custom_xml
    assert report["comparisons"][3]["source"]["structure"]["has_custom_xml"] == expected_docx_has_custom_xml
    expected_docx_header_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["header_count"]
        == report["comparisons"][1]["source"]["structure"]["header_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["header_count"]
        == report["comparisons"][2]["source"]["structure"]["header_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["header_count"]
        == report["comparisons"][3]["source"]["structure"]["header_count"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["header_count"] == expected_docx_header_count
    assert report["comparisons"][1]["source"]["structure"]["header_count"] == expected_docx_header_count
    assert report["comparisons"][2]["generated"]["structure"]["header_count"] == expected_docx_header_count
    assert report["comparisons"][2]["source"]["structure"]["header_count"] == expected_docx_header_count
    assert report["comparisons"][3]["generated"]["structure"]["header_count"] == expected_docx_header_count
    assert report["comparisons"][3]["source"]["structure"]["header_count"] == expected_docx_header_count
    expected_docx_footer_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["footer_count"]
        == report["comparisons"][1]["source"]["structure"]["footer_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["footer_count"]
        == report["comparisons"][2]["source"]["structure"]["footer_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["footer_count"]
        == report["comparisons"][3]["source"]["structure"]["footer_count"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["footer_count"] == expected_docx_footer_count
    assert report["comparisons"][1]["source"]["structure"]["footer_count"] == expected_docx_footer_count
    assert report["comparisons"][2]["generated"]["structure"]["footer_count"] == expected_docx_footer_count
    assert report["comparisons"][2]["source"]["structure"]["footer_count"] == expected_docx_footer_count
    assert report["comparisons"][3]["generated"]["structure"]["footer_count"] == expected_docx_footer_count
    assert report["comparisons"][3]["source"]["structure"]["footer_count"] == expected_docx_footer_count
    expected_docx_body_child_counts = {"p": 1, "sectPr": 1}
    assert (
        report["comparisons"][1]["generated"]["structure"]["body_child_counts"]
        == report["comparisons"][1]["source"]["structure"]["body_child_counts"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["body_child_counts"]
        == report["comparisons"][2]["source"]["structure"]["body_child_counts"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["body_child_counts"]
        == report["comparisons"][3]["source"]["structure"]["body_child_counts"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["body_child_counts"] == expected_docx_body_child_counts
    assert report["comparisons"][1]["source"]["structure"]["body_child_counts"] == expected_docx_body_child_counts
    assert report["comparisons"][2]["generated"]["structure"]["body_child_counts"] == expected_docx_body_child_counts
    assert report["comparisons"][2]["source"]["structure"]["body_child_counts"] == expected_docx_body_child_counts
    assert report["comparisons"][3]["generated"]["structure"]["body_child_counts"] == expected_docx_body_child_counts
    assert report["comparisons"][3]["source"]["structure"]["body_child_counts"] == expected_docx_body_child_counts
    expected_docx_external_relationship_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["external_relationship_count"]
        == report["comparisons"][1]["source"]["structure"]["external_relationship_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["external_relationship_count"]
        == report["comparisons"][2]["source"]["structure"]["external_relationship_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["external_relationship_count"]
        == report["comparisons"][3]["source"]["structure"]["external_relationship_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["external_relationship_count"]
        == expected_docx_external_relationship_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["external_relationship_count"]
        == expected_docx_external_relationship_count
    ...
    expected_docx_external_hyperlink_relationship_count = 0
    assert (
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["external_hyperlink_relationship_count"]
        == report["comparisons"][3]["source"]["structure"]["external_hyperlink_relationship_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["external_hyperlink_relationship_count"]
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["font_names"]
        == report["comparisons"][3]["source"]["structure"]["font_names"]
    )
    ...
    assert report["comparisons"][2]["source"]["structure"]["font_names"] == expected_docx_font_names
    assert report["comparisons"][3]["generated"]["structure"]["font_names"] == expected_docx_font_names
    assert report["comparisons"][3]["source"]["structure"]["font_names"] == expected_docx_font_names
    expected_docx_fonted_run_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["fonted_run_count"]
        == report["comparisons"][1]["source"]["structure"]["fonted_run_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["fonted_run_count"]
        == report["comparisons"][2]["source"]["structure"]["fonted_run_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["fonted_run_count"]
        == report["comparisons"][3]["source"]["structure"]["fonted_run_count"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["fonted_run_count"] == expected_docx_fonted_run_count
    assert report["comparisons"][1]["source"]["structure"]["fonted_run_count"] == expected_docx_fonted_run_count
    assert report["comparisons"][2]["generated"]["structure"]["fonted_run_count"] == expected_docx_fonted_run_count
    assert report["comparisons"][2]["source"]["structure"]["fonted_run_count"] == expected_docx_fonted_run_count
    assert report["comparisons"][3]["generated"]["structure"]["fonted_run_count"] == expected_docx_fonted_run_count
    assert report["comparisons"][3]["source"]["structure"]["fonted_run_count"] == expected_docx_fonted_run_count
    expected_docx_hyperlink_count = 0
    assert (
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["hyperlink_count"]
        == report["comparisons"][3]["source"]["structure"]["hyperlink_count"]
    )
    ...
    assert report["comparisons"][2]["source"]["structure"]["hyperlink_count"] == expected_docx_hyperlink_count
    assert report["comparisons"][3]["generated"]["structure"]["hyperlink_count"] == expected_docx_hyperlink_count
    assert report["comparisons"][3]["source"]["structure"]["hyperlink_count"] == expected_docx_hyperlink_count
    expected_docx_indented_paragraph_count = 0
    assert (
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["indented_paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["indented_paragraph_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["indented_paragraph_count"]
    ...
    expected_docx_italic_run_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["italic_run_count"]
        == report["comparisons"][1]["source"]["structure"]["italic_run_count"]
    )
    assert (
    ...
    assert report["comparisons"][2]["source"]["structure"]["italic_run_count"] == expected_docx_italic_run_count
    assert report["comparisons"][3]["generated"]["structure"]["italic_run_count"] == expected_docx_italic_run_count
    assert report["comparisons"][3]["source"]["structure"]["italic_run_count"] == expected_docx_italic_run_count
    expected_docx_numbered_paragraph_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbered_paragraph_count"]
        == report["comparisons"][1]["source"]["structure"]["numbered_paragraph_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbered_paragraph_count"]
        == report["comparisons"][2]["source"]["structure"]["numbered_paragraph_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbered_paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["numbered_paragraph_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbered_paragraph_count"]
        == expected_docx_numbered_paragraph_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["numbered_paragraph_count"]
        == expected_docx_numbered_paragraph_count
    ...
    expected_docx_numbering_abstract_count = 1
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_abstract_count"]
        == report["comparisons"][1]["source"]["structure"]["numbering_abstract_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_abstract_count"]
        == report["comparisons"][2]["source"]["structure"]["numbering_abstract_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_abstract_count"]
        == report["comparisons"][3]["source"]["structure"]["numbering_abstract_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_abstract_count"]
        == expected_docx_numbering_abstract_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["numbering_abstract_count"]
        == expected_docx_numbering_abstract_count
    ...
    expected_docx_numbering_abstract_ids = ["1"]
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_abstract_ids"]
        == report["comparisons"][1]["source"]["structure"]["numbering_abstract_ids"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_abstract_ids"]
        == report["comparisons"][2]["source"]["structure"]["numbering_abstract_ids"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_abstract_ids"]
        == report["comparisons"][3]["source"]["structure"]["numbering_abstract_ids"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_abstract_ids"]
        == expected_docx_numbering_abstract_ids
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["numbering_abstract_ids"]
        == expected_docx_numbering_abstract_ids
    ...
    expected_docx_numbering_level_count = 2
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_level_count"]
        == report["comparisons"][1]["source"]["structure"]["numbering_level_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_level_count"]
        == report["comparisons"][2]["source"]["structure"]["numbering_level_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_level_count"]
        == report["comparisons"][3]["source"]["structure"]["numbering_level_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_level_count"]
        == expected_docx_numbering_level_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["numbering_level_count"] == expected_docx_numbering_level_count
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_level_count"]
        == expected_docx_numbering_level_count
    ...
    assert (
        report["comparisons"][2]["source"]["structure"]["numbering_level_count"] == expected_docx_numbering_level_count
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_level_count"]
        == expected_docx_numbering_level_count
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_level_fonts"]
        == report["comparisons"][3]["source"]["structure"]["numbering_level_fonts"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_level_fonts"]
    ...
    assert (
        report["comparisons"][2]["source"]["structure"]["numbering_level_fonts"] == expected_docx_numbering_level_fonts
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_level_fonts"]
        == expected_docx_numbering_level_fonts
    ...
    assert (
        report["comparisons"][3]["source"]["structure"]["numbering_level_fonts"] == expected_docx_numbering_level_fonts
    )
    expected_docx_numbering_level_texts = ["\u2022"]
    assert (
        report["comparisons"][1]["generated"]["structure"]["numbering_level_texts"]
        == report["comparisons"][1]["source"]["structure"]["numbering_level_texts"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_level_texts"]
    ...
    assert (
        report["comparisons"][1]["source"]["structure"]["numbering_level_texts"] == expected_docx_numbering_level_texts
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_level_texts"]
        == expected_docx_numbering_level_texts
    ...
    assert (
        report["comparisons"][2]["source"]["structure"]["numbering_level_texts"] == expected_docx_numbering_level_texts
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_level_texts"]
        == expected_docx_numbering_level_texts
    ...
    assert (
        report["comparisons"][3]["source"]["structure"]["numbering_level_texts"] == expected_docx_numbering_level_texts
    )
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_num_count"]
        == report["comparisons"][2]["source"]["structure"]["numbering_num_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_num_count"]
        == report["comparisons"][3]["source"]["structure"]["numbering_num_count"]
    )
    assert (
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["numbering_num_count"] == expected_docx_numbering_num_count
    )
    assert report["comparisons"][2]["source"]["structure"]["numbering_num_count"] == expected_docx_numbering_num_count
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_num_count"] == expected_docx_numbering_num_count
    )
    assert report["comparisons"][3]["source"]["structure"]["numbering_num_count"] == expected_docx_numbering_num_count
    expected_docx_numbering_num_ids = ["1"]
    assert (
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["numbering_num_ids"]
        == report["comparisons"][3]["source"]["structure"]["numbering_num_ids"]
    )
    ...
    expected_docx_page_margins_comparison_2 = {
        "top": "1440",
        "right": "1800",
        "bottom": "1440",
        "left": "1800",
    ...
    assert (
        report["comparisons"][1]["generated"]["structure"]["page_margins"]
        == report["comparisons"][1]["source"]["structure"]["page_margins"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["page_margins"]
        == report["comparisons"][2]["source"]["structure"]["page_margins"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["page_margins"]
        == report["comparisons"][3]["source"]["structure"]["page_margins"]
    )
    assert report["comparisons"][2]["generated"]["structure"]["page_margins"] == expected_docx_page_margins_comparison_2
    assert report["comparisons"][2]["source"]["structure"]["page_margins"] == expected_docx_page_margins_comparison_2
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["page_size"]
        == report["comparisons"][2]["source"]["structure"]["page_size"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["page_size"]
        == report["comparisons"][3]["source"]["structure"]["page_size"]
    )
    ...
    assert report["comparisons"][2]["source"]["structure"]["page_size"] == expected_docx_page_size
    assert report["comparisons"][3]["generated"]["structure"]["page_size"] == expected_docx_page_size
    assert report["comparisons"][3]["source"]["structure"]["page_size"] == expected_docx_page_size
    expected_docx_paragraph_count = 1
    assert (
        report["comparisons"][1]["generated"]["structure"]["paragraph_count"]
        == report["comparisons"][1]["source"]["structure"]["paragraph_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["paragraph_count"]
        == report["comparisons"][2]["source"]["structure"]["paragraph_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["paragraph_count"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["paragraph_count"] == expected_docx_paragraph_count
    assert report["comparisons"][1]["source"]["structure"]["paragraph_count"] == expected_docx_paragraph_count
    assert report["comparisons"][2]["generated"]["structure"]["paragraph_count"] == expected_docx_paragraph_count
    assert report["comparisons"][2]["source"]["structure"]["paragraph_count"] == expected_docx_paragraph_count
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["run_count"]
        == report["comparisons"][2]["source"]["structure"]["run_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["run_count"]
        == report["comparisons"][3]["source"]["structure"]["run_count"]
    )
    ...
    assert report["comparisons"][2]["source"]["structure"]["run_count"] == expected_docx_run_count
    assert report["comparisons"][3]["generated"]["structure"]["run_count"] == expected_docx_run_count
    assert report["comparisons"][3]["source"]["structure"]["run_count"] == expected_docx_run_count
    expected_docx_styled_paragraph_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["styled_paragraph_count"]
        == report["comparisons"][1]["source"]["structure"]["styled_paragraph_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["styled_paragraph_count"]
        == report["comparisons"][2]["source"]["structure"]["styled_paragraph_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["styled_paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["styled_paragraph_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["styled_paragraph_count"]
        == expected_docx_styled_paragraph_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["styled_paragraph_count"]
        == expected_docx_styled_paragraph_count
    ...
    expected_docx_aligned_paragraph_count = 0
    assert (
    ...
    assert (
        ...
        == report["comparisons"][2]["source"]["structure"]["aligned_paragraph_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["aligned_paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["aligned_paragraph_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["aligned_paragraph_count"]
    ...
    expected_docx_spaced_paragraph_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["spaced_paragraph_count"]
        == report["comparisons"][1]["source"]["structure"]["spaced_paragraph_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["spaced_paragraph_count"]
        == report["comparisons"][2]["source"]["structure"]["spaced_paragraph_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["spaced_paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["spaced_paragraph_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["spaced_paragraph_count"]
        == expected_docx_spaced_paragraph_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["spaced_paragraph_count"]
        == expected_docx_spaced_paragraph_count
    ...
    expected_docx_tab_stopped_paragraph_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["tab_stopped_paragraph_count"]
        == report["comparisons"][1]["source"]["structure"]["tab_stopped_paragraph_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["tab_stopped_paragraph_count"]
    ...
    assert (
        report["comparisons"][2]["generated"]["structure"]["table_count"]
        == report["comparisons"][2]["source"]["structure"]["table_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["table_count"]
        == report["comparisons"][3]["source"]["structure"]["table_count"]
    )
    ...
    assert report["comparisons"][2]["source"]["structure"]["table_count"] == expected_docx_table_count
    assert report["comparisons"][3]["generated"]["structure"]["table_count"] == expected_docx_table_count
    assert report["comparisons"][3]["source"]["structure"]["table_count"] == expected_docx_table_count
    expected_docx_table_cell_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["table_cell_count"]
        == report["comparisons"][1]["source"]["structure"]["table_cell_count"]
    )
    ...
    assert (
        report["comparisons"][3]["generated"]["structure"]["table_cell_count"]
        == report["comparisons"][3]["source"]["structure"]["table_cell_count"]
    )
    assert report["comparisons"][3]["generated"]["structure"]["table_cell_count"] == expected_docx_table_cell_count
    assert report["comparisons"][3]["source"]["structure"]["table_cell_count"] == expected_docx_table_cell_count
    expected_docx_table_cell_widths: list[list[list[str]]] = []
    assert (
        report["comparisons"][1]["generated"]["structure"]["table_cell_widths"]
        == report["comparisons"][1]["source"]["structure"]["table_cell_widths"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["table_cell_widths"] == expected_docx_table_cell_widths
    assert report["comparisons"][1]["source"]["structure"]["table_cell_widths"] == expected_docx_table_cell_widths
    assert (
        report["comparisons"][2]["generated"]["structure"]["table_cell_widths"]
        == report["comparisons"][2]["source"]["structure"]["table_cell_widths"]
    )
    assert report["comparisons"][2]["generated"]["structure"]["table_cell_widths"] == expected_docx_table_cell_widths
    assert report["comparisons"][2]["source"]["structure"]["table_cell_widths"] == expected_docx_table_cell_widths
    assert (
        report["comparisons"][3]["generated"]["structure"]["table_cell_widths"]
        == report["comparisons"][3]["source"]["structure"]["table_cell_widths"]
    )
    assert report["comparisons"][3]["generated"]["structure"]["table_cell_widths"] == expected_docx_table_cell_widths
    assert report["comparisons"][3]["source"]["structure"]["table_cell_widths"] == expected_docx_table_cell_widths
    expected_docx_table_grid_widths: list[str] = []
    assert (
        report["comparisons"][1]["generated"]["structure"]["table_grid_widths"]
        == report["comparisons"][1]["source"]["structure"]["table_grid_widths"]
    )
    assert (
    ...
    assert report["comparisons"][3]["generated"]["structure"]["table_grid_widths"] == expected_docx_table_grid_widths
    assert report["comparisons"][3]["source"]["structure"]["table_grid_widths"] == expected_docx_table_grid_widths
    expected_docx_table_paragraph_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["table_paragraph_count"]
        == report["comparisons"][1]["source"]["structure"]["table_paragraph_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["table_paragraph_count"]
        == report["comparisons"][2]["source"]["structure"]["table_paragraph_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["table_paragraph_count"]
        == report["comparisons"][3]["source"]["structure"]["table_paragraph_count"]
    )
    assert (
        report["comparisons"][1]["generated"]["structure"]["table_paragraph_count"]
        == expected_docx_table_paragraph_count
    )
    assert (
        report["comparisons"][1]["source"]["structure"]["table_paragraph_count"] == expected_docx_table_paragraph_count
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["table_paragraph_count"]
        == expected_docx_table_paragraph_count
    ...
    assert (
        report["comparisons"][2]["source"]["structure"]["table_paragraph_count"] == expected_docx_table_paragraph_count
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["table_paragraph_count"]
        == expected_docx_table_paragraph_count
    ...
    assert (
        report["comparisons"][3]["source"]["structure"]["table_paragraph_count"] == expected_docx_table_paragraph_count
    )
    expected_docx_table_row_count = 0
    assert (
        report["comparisons"][1]["generated"]["structure"]["table_row_count"]
        == report["comparisons"][1]["source"]["structure"]["table_row_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["table_row_count"]
        == report["comparisons"][2]["source"]["structure"]["table_row_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["table_row_count"]
        == report["comparisons"][3]["source"]["structure"]["table_row_count"]
    )
    assert report["comparisons"][1]["generated"]["structure"]["table_row_count"] == expected_docx_table_row_count
    assert report["comparisons"][1]["source"]["structure"]["table_row_count"] == expected_docx_table_row_count
    assert report["comparisons"][2]["generated"]["structure"]["table_row_count"] == expected_docx_table_row_count
    ...
    assert (
        report["comparisons"][1]["generated"]["structure"]["bold_run_count"]
        == report["comparisons"][1]["source"]["structure"]["bold_run_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["bold_run_count"]
        == report["comparisons"][2]["source"]["structure"]["bold_run_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["bold_run_count"]
        == report["comparisons"][3]["source"]["structure"]["bold_run_count"]
    )
    ...
    assert report["comparisons"][2]["generated"]["structure"]["bold_run_count"] == expected_docx_bold_run_count
    assert report["comparisons"][2]["source"]["structure"]["bold_run_count"] == expected_docx_bold_run_count
    assert report["comparisons"][3]["generated"]["structure"]["bold_run_count"] == expected_docx_bold_run_count
    assert report["comparisons"][3]["source"]["structure"]["bold_run_count"] == expected_docx_bold_run_count
    ...
    assert report["comparisons"][1]["source"]["structure"]["underline_run_count"] == expected_docx_underline_run_count
    assert (
        report["comparisons"][1]["generated"]["structure"]["underline_run_count"]
        == report["comparisons"][1]["source"]["structure"]["underline_run_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["underline_run_count"]
        == report["comparisons"][2]["source"]["structure"]["underline_run_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["underline_run_count"]
        == report["comparisons"][3]["source"]["structure"]["underline_run_count"]
    )
    assert (
    ...
    expected_docx_colored_run_count = 0
    assert report["comparisons"][1]["generated"]["structure"]["colored_run_count"] == expected_docx_colored_run_count
    assert report["comparisons"][1]["source"]["structure"]["colored_run_count"] == expected_docx_colored_run_count
    assert (
        report["comparisons"][1]["generated"]["structure"]["colored_run_count"]
        == report["comparisons"][1]["source"]["structure"]["colored_run_count"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["colored_run_count"]
        == report["comparisons"][2]["source"]["structure"]["colored_run_count"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["colored_run_count"]
        == report["comparisons"][3]["source"]["structure"]["colored_run_count"]
    )
    assert report["comparisons"][2]["generated"]["structure"]["colored_run_count"] == expected_docx_colored_run_count
    assert report["comparisons"][2]["source"]["structure"]["colored_run_count"] == expected_docx_colored_run_count
    assert report["comparisons"][3]["generated"]["structure"]["colored_run_count"] == expected_docx_colored_run_count
    assert report["comparisons"][3]["source"]["structure"]["colored_run_count"] == expected_docx_colored_run_count
    expected_docx_default_style_ids = ["Normal"]
    assert report["comparisons"][1]["generated"]["structure"]["default_style_ids"] == expected_docx_default_style_ids
    assert report["comparisons"][1]["source"]["structure"]["default_style_ids"] == expected_docx_default_style_ids
    assert (
        report["comparisons"][1]["generated"]["structure"]["default_style_ids"]
        == report["comparisons"][1]["source"]["structure"]["default_style_ids"]
    )
    assert report["comparisons"][2]["generated"]["structure"]["default_style_ids"] == expected_docx_default_style_ids
    assert report["comparisons"][2]["source"]["structure"]["default_style_ids"] == expected_docx_default_style_ids
    assert (
        report["comparisons"][2]["generated"]["structure"]["default_style_ids"]
        == report["comparisons"][2]["source"]["structure"]["default_style_ids"]
    )
    assert report["comparisons"][3]["generated"]["structure"]["default_style_ids"] == expected_docx_default_style_ids
    assert report["comparisons"][3]["source"]["structure"]["default_style_ids"] == expected_docx_default_style_ids
    assert (
        report["comparisons"][3]["generated"]["structure"]["default_style_ids"]
        == report["comparisons"][3]["source"]["structure"]["default_style_ids"]
    )
    expected_docx_style_definition_ids = [
        "Normal",
        "Title",
        "Heading1",
        "Heading2",
    ...
    assert (
        report["comparisons"][1]["generated"]["structure"]["style_definition_ids"] == expected_docx_style_definition_ids
    )
    assert report["comparisons"][1]["source"]["structure"]["style_definition_ids"] == expected_docx_style_definition_ids
    assert (
        report["comparisons"][1]["generated"]["structure"]["style_definition_ids"]
        == report["comparisons"][1]["source"]["structure"]["style_definition_ids"]
    )
    assert (
        report["comparisons"][2]["generated"]["structure"]["style_definition_ids"] == expected_docx_style_definition_ids
    )
    assert report["comparisons"][2]["source"]["structure"]["style_definition_ids"] == expected_docx_style_definition_ids
    assert (
        report["comparisons"][2]["generated"]["structure"]["style_definition_ids"]
        == report["comparisons"][2]["source"]["structure"]["style_definition_ids"]
    )
    assert (
        report["comparisons"][3]["generated"]["structure"]["style_definition_ids"] == expected_docx_style_definition_ids
    )
    assert report["comparisons"][3]["source"]["structure"]["style_definition_ids"] == expected_docx_style_definition_ids
    assert (
        report["comparisons"][3]["generated"]["structure"]["style_definition_ids"]
        == report["comparisons"][3]["source"]["structure"]["style_definition_ids"]
    )
    ...
    assert "| has_endnotes | true | true |" in resume_2017_docx_section
    assert "| has_custom_xml | true | true |" in resume_2017_docx_section
    assert "| header_count | 0 | 0 |" in resume_2017_docx_section
    assert "| footer_count | 0 | 0 |" in resume_2017_docx_section
    assert '| body_child_counts | {"p": 1, "sectPr": 1} | {"p": 1, "sectPr": 1} |' in resume_2017_docx_section
    assert "| relationship_count | 9 | 9 |" in resume_2017_docx_section
    assert (
        '| relationship_type_counts | {"customXml": 1, "endnotes": 1, "fontTable": 1, "footnotes": 1, '
        '"numbering": 1, "settings": 1, "styles": 1, "theme": 1, "webSettings": 1} | '
        '{"customXml": 1, "endnotes": 1, "fontTable": 1, "footnotes": 1, "numbering": 1, '
        '"settings": 1, "styles": 1, "theme": 1, "webSettings": 1} |' in resume_2017_docx_section
    )
    assert "| relationship_target_mode_counts | {} | {} |" in resume_2017_docx_section
    assert "| external_relationship_count | 0 | 0 |" in resume_2017_docx_section
    ...
    assert "| styles | [] | [] |" in resume_2024_docx_section
    ...
    assert "| section_footer_references | [] | [] |" in resume_2017_docx_section
    assert "| paragraph_count | 1 | 1 |" in resume_2017_docx_section
    assert "| run_count | 1 | 1 |" in resume_2017_docx_section
    assert "| styled_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| aligned_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| spaced_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| indented_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| tab_stopped_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| bold_run_count | 0 | 0 |" in resume_2017_docx_section
    assert "| italic_run_count | 0 | 0 |" in resume_2017_docx_section
    assert "| underline_run_count | 0 | 0 |" in resume_2017_docx_section
    assert "| colored_run_count | 0 | 0 |" in resume_2017_docx_section
    ...
    assert "| table_cell_count | 0 | 0 |" in resume_2017_docx_section
    assert "| table_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| table_grid_widths | [] | [] |" in resume_2017_docx_section
    assert "| table_cell_widths | [] | [] |" in resume_2017_docx_section
    assert "| numbered_paragraph_count | 0 | 0 |" in resume_2017_docx_section
    assert "| numbering_abstract_count | 1 | 1 |" in resume_2017_docx_section
    assert "| numbering_num_count | 1 | 1 |" in resume_2017_docx_section
    assert "| numbering_level_count | 2 | 2 |" in resume_2017_docx_section
    numbering_level_texts_row_2017 = next(
        line for line in resume_2017_docx_section.splitlines() if line.startswith("| numbering_level_texts |")
    )
    numbering_level_texts_parts_2017 = [part.strip() for part in numbering_level_texts_row_2017.strip("|").split("|")]
    ...
    assert "| has_footnotes | true | true |" in resume_2023_docx_section
    assert "| has_endnotes | true | true |" in resume_2023_docx_section
    assert "| has_custom_xml | true | true |" in resume_2023_docx_section
    assert "| header_count | 0 | 0 |" in resume_2023_docx_section
    assert "| footer_count | 0 | 0 |" in resume_2023_docx_section
    assert '| body_child_counts | {"p": 1, "sectPr": 1} | {"p": 1, "sectPr": 1} |' in resume_2023_docx_section
    assert "| relationship_count | 9 | 9 |" in resume_2023_docx_section
    assert (
        '| relationship_type_counts | {"customXml": 1, "endnotes": 1, "fontTable": 1, "footnotes": 1, '
        '"numbering": 1, "settings": 1, "styles": 1, "theme": 1, "webSettings": 1} | '
        '{"customXml": 1, "endnotes": 1, "fontTable": 1, "footnotes": 1, "numbering": 1, '
        '"settings": 1, "styles": 1, "theme": 1, "webSettings": 1} |' in resume_2023_docx_section
    )
    assert "| relationship_target_mode_counts | {} | {} |" in resume_2023_docx_section
    assert "| external_relationship_count | 0 | 0 |" in resume_2023_docx_section
    ...
    assert "| section_header_references | [] | [] |" in resume_2023_docx_section
    ...
    assert "| run_count | 1 | 1 |" in resume_2023_docx_section
    assert "| styled_paragraph_count | 0 | 0 |" in resume_2023_docx_section
    assert "| aligned_paragraph_count | 0 | 0 |" in resume_2023_docx_section
    assert "| spaced_paragraph_count | 0 | 0 |" in resume_2023_docx_section
    assert "| indented_paragraph_count | 0 | 0 |" in resume_2023_docx_section
    ...
    assert "| colored_run_count | 0 | 0 |" in resume_2023_docx_section
    assert "| fonted_run_count | 0 | 0 |" in resume_2023_docx_section
    assert "| hyperlink_count | 0 | 0 |" in resume_2023_docx_section
    assert "| tab_count | 0 | 0 |" in resume_2023_docx_section
    assert "| table_count | 0 | 0 |" in resume_2023_docx_section
    ...
    assert "| table_cell_widths | [] | [] |" in resume_2023_docx_section
    ...
    numbering_level_texts_parts_2023 = [part.strip() for part in numbering_level_texts_row_2023.strip("|").split("|")]
    assert numbering_level_texts_parts_2023[1] == numbering_level_texts_parts_2023[2]
    assert (
    ...
    assert "| has_footnotes | true | true |" in resume_2024_docx_section
    assert "| has_endnotes | true | true |" in resume_2024_docx_section
    assert "| has_custom_xml | true | true |" in resume_2024_docx_section
    assert "| header_count | 0 | 0 |" in resume_2024_docx_section
    ...
    assert (
        ...
        '"numbering": 1, "settings": 1, "styles": 1, "theme": 1, "webSettings": 1} | '
        '{"customXml": 1, "endnotes": 1, "fontTable": 1, "footnotes": 1, "numbering": 1, '
        '"settings": 1, "styles": 1, "theme": 1, "webSettings": 1} |' in resume_2024_docx_section
    )
    ...
    assert "| section_header_references | [] | [] |" in resume_2024_docx_section
    ...
    assert "| section_footer_references | [] | [] |" in resume_2024_docx_section
    assert "| paragraph_count | 1 | 1 |" in resume_2024_docx_section
    assert "| run_count | 1 | 1 |" in resume_2024_docx_section
    assert "| styled_paragraph_count | 0 | 0 |" in resume_2024_docx_section
    ...
    assert "| bold_run_count | 0 | 0 |" in resume_2024_docx_section
    ...
    assert "| table_row_count | 0 | 0 |" in resume_2024_docx_section
    assert "| table_cell_count | 0 | 0 |" in resume_2024_docx_section
    assert "| table_paragraph_count | 0 | 0 |" in resume_2024_docx_section
    ...
    assert "| numbering_num_count | 1 | 1 |" in resume_2024_docx_section
    assert "| numbering_level_count | 2 | 2 |" in resume_2024_docx_section
    ...
    assert (
        '| workbook_relationship_targets | {"rId1": "xl/worksheets/sheet1.xml", '
        '"rId10": "xl/styles.xml", "rId2": "xl/worksheets/sheet2.xml", '
        '"rId3": "xl/worksheets/sheet3.xml", "rId4": "xl/worksheets/sheet4.xml", '
        '"rId5": "xl/worksheets/sheet5.xml", "rId6": "xl/worksheets/sheet6.xml", '
        '"rId7": "xl/worksheets/sheet7.xml", "rId8": "xl/worksheets/sheet8.xml", '
        '"rId9": "xl/worksheets/sheet9.xml"} | {"rId1": "xl/worksheets/sheet1.xml", '
        '"rId10": "xl/styles.xml", "rId2": "xl/worksheets/sheet2.xml", '
        '"rId3": "xl/worksheets/sheet3.xml", "rId4": "xl/worksheets/sheet4.xml", '
        '"rId5": "xl/worksheets/sheet5.xml", "rId6": "xl/worksheets/sheet6.xml", '
        '"rId7": "xl/worksheets/sheet7.xml", "rId8": "xl/worksheets/sheet8.xml", '
        '"rId9": "xl/worksheets/sheet9.xml"} |' in audit_text
    )
    assert (
